...
<head>
  ...
  <!-- Favicons -->
  <link href="http://localhost/project/public/assets/img/favicon.png" rel="icon">
  <link href="http://localhost/project/public/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="/project/public/">Kelly</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="active" href="/project/public/">Home</a></li>
          <li><a href="/project/public/about">About</a></li>
          <li><a href="/project/public/resume">Resume</a></li>
          <li><a href="/project/public/services">Services</a></li>
...
<!-- 
  ...
  <!-- Vendor JS Files -->
  <script src="http://localhost/project/public/assets/vendor/purecounter/purecounter_vanilla.js"></script>
